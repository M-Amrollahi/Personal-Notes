...
## استنباط و آزمون فرض آماری
- استنباط و آزمون فرض آماری یک روش استقرایی هستند. به این معنی که با استفاده از امور جزئی به قانون کلی پی‌ می‌بریم. استفاده از اطلاعاتی که یک نمونه، از جامعه آماری در اختیارمان می‌گذارد تا رسیدن به قانونی کلی در مورد این جامعه، مراحل یک تحلیل آماری هستند.
...
- از تحلیل آماری برای آزمون فرضیه و برآورد برای ویژگیها و روابط بین آنها استفاده میشود.
...
- توزیع آماری:  توزیع آماری نشان می‌دهد که مقدارهای مربوط به ویژگی‌ها، به شکل خاصی در بین اعضای جامعه توزیع شده‌اند.
- آماره != پارامتر جامعه
- دو رویکرد در تحلیلهای آماری وجود دارد. برآوردیابی ، آزمون فرض
- برآوردیابی: اگر هدف از تحلیل آماری، برآورد پارامتر جامعه آماری باشد بطوری که دقت برآورد نیز قابل محاسبه باشد، «برآوردیابی» (Estimation) انجام شده است. آماره‌ای که برای عمل برآوردیابی به کار گرفته شده نیز «برآوردگر» (Estimator) و نتیجه حاصل از آماره توسط مقدارهای نمونه تصادفی را «برآورد» (Estimate) پارامتر جامعه می‌گویند. برآورد نقطه ای و برآورد فاصله ای
- آزمون فرض آماری: در روش‌های مربوط به آزمون فرض آماری، یک گزاره در مورد پارامتر جامعه آماری مورد بررسی قرار می‌گیرد و برعکس روش‌های برآوردیابی، برای پارامتر جامعه مقداری را محاسبه نمی‌کند.
